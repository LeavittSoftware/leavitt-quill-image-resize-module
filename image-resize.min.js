...
var Stack = __webpack_require__(41),
    ...
    baseFor = __webpack_require__(46),
    baseMergeDeep = __webpack_require__(51),
    isObject = __webpack_require__(0),
...
var identity = __webpack_require__(26),
    overRest = __webpack_require__(89),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_quill_assets_icons_align_left_svg__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_quill_assets_icons_align_center_svg__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_quill_assets_icons_align_right_svg__ = __webpack_require__(106);
...
var apply = __webpack_require__(17),
    ...
    customDefaultsMerge = __webpack_require__(63),
    mergeWith = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_debounce__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_debounce___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_debounce__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_DisplaySize__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Toolbar__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_Resize__ = __webpack_require__(35);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var knownModules = {
	DisplaySize: __WEBPACK_IMPORTED_MODULE_3__modules_DisplaySize__["a" /* DisplaySize */],
	Toolbar: __WEBPACK_IMPORTED_MODULE_4__modules_Toolbar__["a" /* Toolbar */],
	Resize: __WEBPACK_IMPORTED_MODULE_5__modules_Resize__["a" /* Resize */]
};
...
var ImageResize = function ImageResize(quill) {
	...
	this.handleClick = function (evt) {
		...
		if (evt.target && evt.target.tagName && evt.target.tagName.toUpperCase() === 'HOME-SECURE-IMAGE') {
			target = Array.from(evt.target.shadowRoot.children).filter(function (i) {
				return i.tagName === 'IMG';
			})[0];
			_this.homeSecureImage = evt.target;
	...
	this.repositionElements = function () {
		...
		var setHomeSecureImageHeight = __WEBPACK_IMPORTED_MODULE_1_lodash_debounce___default()(function () {
			if (!_this.overlay) return;
			var homeSecureImage = Array.from(parent.children[0].children).filter(function (i) {
				return i.tagName === 'HOME-SECURE-IMAGE';
			})[0];
			homeSecureImage.setAttribute('height', parseInt(_this.overlay.style.height));
		}, 800);
	...
	this.checkImage = function (evt) {
		if (_this.img) {
			if (evt.keyCode == 46 || evt.keyCode == 8) {
				window.Quill.find(_this.homeSecureImage).deleteAt(0);
			}
			_this.hide();
		}
	};
	...
	this.options = __WEBPACK_IMPORTED_MODULE_0_lodash_defaultsDeep___default()({}, options, __WEBPACK_IMPORTED_MODULE_2__DefaultOptions__["a" /* default */]);
...
var assignMergeValue = __webpack_require__(18),
    ...
    initCloneObject = __webpack_require__(71),
    isArguments = __webpack_require__(27),
    isArray = __webpack_require__(28),
...
var baseCreate = __webpack_require__(45),
