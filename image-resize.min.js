...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BaseModule__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_debounce__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_Resize__ = __webpack_require__(35);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var knownModules = {
	...
	Resize: __WEBPACK_IMPORTED_MODULE_4__modules_Resize__["a" /* Resize */]
};
...
var ImageResize = function ImageResize(quill) {
	...
	this.handleClick = function (evt) {
		...
		_this.show(target, homeSecureImage);
	};

	this.show = function (img, homeSecureImage) {
		// keep track of this img element
		_this.img = img;
		_this.homeSecureImage = homeSecureImage;
		_this.showOverlay();
	...
	this.repositionElements = function () {
		...
		var setHomeSecureImageHeight = __WEBPACK_IMPORTED_MODULE_1_lodash_debounce___default()(function () {
			if (!_this.homeSecureImage) return;
			_this.homeSecureImage.setAttribute('height', parseInt(_this.overlay.style.height));
			_this.homeSecureImage.setAttribute('width', parseInt(_this.overlay.style.width));
		}, 800);
	...
	this.hide = function () {
		...
		_this.removeModules();
		_this.img = undefined;
		_this.homeSecureImage = undefined;
	};
	...
	this.checkImage = function (evt) {
		if (_this.img) {
			if (evt.keyCode == 46 || evt.keyCode == 8) {
				if (_this.homeSecureImage) window.Quill.find(_this.homeSecureImage).deleteAt(0);else window.Quill.find(_this.img).deleteAt(0);
			}
			_this.hide();
		}
	};
